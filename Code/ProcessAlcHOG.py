...
#3 lata de alcohol
#4 copas de vino
X1,Y1=getArrayOfImagesFromDir(directory3,1,True,HOG=True)
X2,Y2=getArrayOfImagesFromDir(directory8,1,HOG=True)
X=numpy.append(X1,X2,axis=0)
Y=numpy.append(Y1,Y2,axis=0)

X3,Y3=getArrayOfImagesFromDir(directory5,0,HOG=True)
X=numpy.append(X,X3,axis=0)
Y=numpy.append(Y,Y3,axis=0)
X4,Y4=getArrayOfImagesFromDir(directory6,0,HOG=True)
X=numpy.append(X,X4,axis=0)
Y=numpy.append(Y,Y4,axis=0)
X4,Y4=getArrayOfImagesFromDir(directory9,0,HOG=True)
X=numpy.append(X,X4,axis=0)
Y=numpy.append(Y,Y4,axis=0)
X4,Y4=getArrayOfImagesFromDir(directory7,0,HOG=True)
X=numpy.append(X,X4,axis=0)
Y=numpy.append(Y,Y4,axis=0)
X4,Y4=getArrayOfImagesFromDir(directory10,0,HOG=True)
X=numpy.append(X,X4,axis=0)
Y=numpy.append(Y,Y4,axis=0)
...
t=h5py.File('../Images/DatasetAlcoholHOG.h5','w')
